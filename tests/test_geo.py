...
@pytest.mark.parametrize(
    ...
    [
        ...
        # UFs sem polo principal especificado
        ("Vitória, ES", "Presencial", "Estado/ES", "Sudeste"),
        ("Natal, RN", "Presencial", "Estado/RN", "Nordeste"),
        ("Cuiabá, MT", "Presencial", "Estado/MT", "Centro-Oeste"),
        # Vagas remotas
