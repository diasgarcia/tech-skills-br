...
Este documento é o guia operacional completo para a execução dos coletores, filtros, importação para o banco de dados e geração de relatórios estatísticos do projeto.
...
Os dados consolidados são servidos gratuitamente com **CORS liberado** na URL pública:
...
| :--- | :--- | :--- |
| **`/api/resumo.json`** | KPIs, metadados, distribuições e comparativo projeto | `https://diasgarcia.github.io/tech-skills-br/api/resumo.json` |
