...
Este projeto de dados foi construído e expandido a partir da base inicial do repositório [vagas-tech-junior](https://github.com/EmidioLP/vagas-tech-junior), idealizado e desenvolvido por:
...
Agradecemos o trabalho fundacional de raspagem e estruturação inicial que viabilizou este projeto (projeto).
