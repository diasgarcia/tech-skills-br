...
Para produzir esses dados com evidências quantitativas e reprodutíveis, este projeto implementa um pipeline completo de coleta multi-fonte, amostragem estratificada por polos tecnológicos, extração de tecnologias por taxonomia curada, deduplicação e análise estatística.
...
Este projeto de dados acadêmica foi desenvolvido a partir da concepção e base inicial do repositório de código aberto [**vagas-tech-junior**](https://github.com/EmidioLP/vagas-tech-junior), idealizado e desenvolvido por:
...
Agradecemos pelo trabalho fundacional de raspagem e estruturação inicial que possibilitou a expansão deste ecossistema para mineração científica de dados, taxonomia avançada de *skills* e análise técnica (projeto).
